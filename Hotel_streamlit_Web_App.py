...
reviews = pd.read_excel(r'C:\Users\hites\OneDrive\ExcelR\Hotel Rating Classification Project ExcelR\hotel_reviews.xlsx')
df = pd.read_csv(r'C:\Users\hites\OneDrive\ExcelR\Hotel Rating Classification Project ExcelR\Hotel_Noun.csv')
...
def main():
    ...
    if page == "Sentiment Analysis":
        ...
        if st.button("Submit") and user_input_sentiment.strip() != "":
            ...
            st.write(f"Unique Keywords from Review: {all_nouns}")
